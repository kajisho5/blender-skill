...
| RM-009 | inspect | ボーン階層と重み未割当頂点の検出 | done | #10 |
...
| RM-016 | convert | USD/USDZ 出力の iOS Quick Look 互換性検証 | done | #16 |
...
| RM-037 | optimize | インスタンス化（同一メッシュを共有） | done | #30 |
...
| RM-040 | optimize | 最適化前後の視覚差分スコア（レンダ画像のPSNR/SSIMを純Pythonで） | done | #33 |
